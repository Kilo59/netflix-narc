...
async def test_action_help_pushes_help_screen(
    no_onboard_settings: Settings, tmp_path: pathlib.Path
) -> None:
    """Pressing 'h' should push a HelpScreen onto the screen stack."""
    app = NetflixNarcApp(settings=no_onboard_settings, csv_path=None, cache_dir=tmp_path)
...
async def test_action_question_mark_pushes_help_screen(
    no_onboard_settings: Settings, tmp_path: pathlib.Path
) -> None:
...
async def test_help_button_from_preferences_opens_help(
    no_onboard_settings: Settings, tmp_path: pathlib.Path
) -> None:
...
async def test_help_screen_dismiss_pops_screen(
    no_onboard_settings: Settings, tmp_path: pathlib.Path
) -> None:
